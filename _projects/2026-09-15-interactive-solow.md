...
<div style="margin-top: 15px; margin-bottom: 30px;">
  <a href="https://github.com/aidaana/solow-interactive-model.git" target="_blank" style="display: inline-flex; align-items: center; gap: 6px; padding: 5px 12px; border: 1px solid light-dark(#ccc, #444); border-radius: 4px; color: light-dark(#333, #ccc); font-size: 0.85em; text-decoration: none; background: transparent; font-weight: 500;">
    📁 Code & Data on GitHub →
  </a>
</div>
